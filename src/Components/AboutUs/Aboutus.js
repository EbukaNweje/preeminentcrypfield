  ...
  return (
    <Container>
        ...
        <H1 data-aos="fade-down">About us</H1>
           ...
           Since you are on the About us page, we have to introduce ourselves.<br/>So...Hello, we are a friendly premium-cryptaseets team.
           <br/>
           <br/>
           <br/>
